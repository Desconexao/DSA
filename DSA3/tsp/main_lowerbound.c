...
int calculateLowerBound(int nVertex, int adjacencyMatrix[nVertex][nVertex],
                        int visited[nVertex], int currentVertex);
...
void branchAndBound(int nVertex, int adjacencyMatrix[nVertex][nVertex],
    ...
    for (int vertex = 0; vertex < nVertex; vertex++) {
        if (!visited[vertex]) {
            ...
            int lowerBound =
                calculateLowerBound(nVertex, adjacencyMatrix, visited, vertex);
...
int calculateLowerBound(int nVertex, int adjacencyMatrix[nVertex][nVertex],
    ...
    for (int vertex = 0; vertex < nVertex; vertex++) {
        if (!visited[vertex]) {
            ...
            for (int neighbor = 0; neighbor < nVertex; neighbor++) {
                if (vertex != neighbor &&
                    adjacencyMatrix[vertex][neighbor] < minCost) {

                    minCost = adjacencyMatrix[vertex][neighbor];
                }
            }
            lowerBound += minCost;
        }
